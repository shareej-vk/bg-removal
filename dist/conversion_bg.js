...
/**
 */
export const ResizeAlgorithm = Object.freeze({
  Nearest: 0,
  0: "Nearest",
  Triangle: 1,
  1: "Triangle",
...
export class ConversionOptions {
  ...
  get keep_transparency() {
    const ret = wasm.__wbg_get_conversionoptions_keep_transparency(
      this.__wbg_ptr,
    );
    return ret !== 0;
  }
  ...
  get enable_palette_reduction() {
    const ret = wasm.__wbg_get_conversionoptions_enable_palette_reduction(
      this.__wbg_ptr,
    );
    return ret !== 0;
  }
  ...
  set enable_palette_reduction(arg0) {
    wasm.__wbg_set_conversionoptions_enable_palette_reduction(
      this.__wbg_ptr,
      arg0,
    );
  }
  ...
  set palette_size(arg0) {
    wasm.__wbg_set_conversionoptions_palette_size(
      this.__wbg_ptr,
      !isLikeNone(arg0),
  ...
  set resize_width(arg0) {
    wasm.__wbg_set_conversionoptions_resize_width(
      this.__wbg_ptr,
      !isLikeNone(arg0),
      isLikeNone(arg0) ? 0 : arg0,
    );
  ...
  set resize_height(arg0) {
    wasm.__wbg_set_conversionoptions_resize_height(
      this.__wbg_ptr,
      !isLikeNone(arg0),
      isLikeNone(arg0) ? 0 : arg0,
    );
  ...
  get resize_algorithm() {
    const ret = wasm.__wbg_get_conversionoptions_resize_algorithm(
      this.__wbg_ptr,
    );
    return ret;
  }
  ...
  get maintain_aspect_ratio() {
    const ret = wasm.__wbg_get_conversionoptions_maintain_aspect_ratio(
      this.__wbg_ptr,
    );
    return ret !== 0;
  }
  ...
  set maintain_aspect_ratio(arg0) {
    wasm.__wbg_set_conversionoptions_maintain_aspect_ratio(
      this.__wbg_ptr,
      arg0,
    );
  }
  ...
  constructor(
    ...
    const ret = wasm.conversionoptions_new(
      ...
      isLikeNone(palette_size) ? 0 : palette_size,
      enable_resize,
